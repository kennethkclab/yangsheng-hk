    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          <button type="button" onClick={prev} className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-stone-200 bg-white text-stone-700 hover:bg-brand-50 hover:text-brand-800" aria-label="Previous">
            ←
          </button>
          ...
          <button type="button" onClick={next} className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-stone-200 bg-white text-stone-700 hover:bg-brand-50 hover:text-brand-800" aria-label="Next">
            →
          </button>
        </div>
      </div>
