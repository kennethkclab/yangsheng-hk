          ...
          >
            {item.id === "youtube" ? (
              ...
              <span className="flex h-full w-full items-center justify-center bg-black">
                <svg viewBox="0 0 24 24" className="h-6 w-6 scale-110" aria-hidden>
                  ...
                  <path fill="#FE2C55" d="M13.6 2.4c.5 2.6 2.2 4.4 4.8 4.8v3.1c-1.6 0-3.1-.5-4.4-1.3v6.6c0 3.4-2.7 6.1-6.1 6.1S1.8 19 1.8 15.6 4.5 9.5 7.9 9.5c.4 0 .8 0 1.1.1v3.2c-.3-.1-.7-.2-1.1-.2-1.6 0-2.9 1.3-2.9 3s1.3 3 2.9 3 2.9-1.3 2.9-3V2.4h2.8z" opacity=".85" />
