      ...
      <main className="min-h-screen bg-stone-50">
        ...
        <section className="mx-auto max-w-5xl px-4 py-16">
            ...
            {siteData.courses.map((course, index) => (
              ...
              >
                <div className="grid md:grid-cols-5">
                  <div className="md:col-span-2 bg-brand-50 flex items-center justify-center p-10">
                    <div className="text-center">
                      <div className="mb-3 text-4xl font-bold text-brand-700">
          ...
          <div className="mt-12 rounded-2xl bg-brand-800 p-8 text-center text-white">
            <h3 className="mb-3 text-xl font-bold">想了解更多課程詳情？</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block rounded-full bg-white px-8 py-3 text-sm font-medium text-brand-800 transition hover:bg-brand-50"
            >
              立即 WhatsApp 查詢
            </a>
          </div>
