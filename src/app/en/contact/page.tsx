  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-stone-50">
        <PageHero title={copy.contactTitle} subtitle="Enquiries about classes, events and wellness practice" align="center" image={CONTACT_HERO} overlay="soft" imagePosition="center 52%" />
