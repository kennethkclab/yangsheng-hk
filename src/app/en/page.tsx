        ...
        <section className="relative min-h-[72vh] overflow-hidden md:min-h-[78vh]">
          ...
          <div className="relative mx-auto flex min-h-[72vh] max-w-6xl items-center px-4 py-16 md:min-h-[78vh] md:py-24">
            <div className="max-w-xl md:max-w-2xl">
              <p className="mb-4 inline-block rounded-md bg-white/20 px-4 py-1.5 text-sm font-medium tracking-wide text-white backdrop-blur-sm">{copy.nature}</p>
              ...
              <p className="mb-8 text-lg leading-relaxed text-white/95 drop-shadow-sm">{copy.heroLead}</p>
              <div className="flex flex-wrap gap-3">
                ...
                <a href={siteData.contact.whatsappUrl} target="_blank" rel="noopener noreferrer" className="rounded-md border-2 border-white/70 px-7 py-3 text-sm font-semibold text-white hover:bg-white/10">{copy.whatsapp}</a>
              </div>
            </div>
          </div>
        </section>
