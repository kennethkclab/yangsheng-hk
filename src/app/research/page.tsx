...
const paragraphs = [
  "袁麗萍教授自幼在深山道觀成長，深諳道家養生之道。她曾多次與香港大學合作，研究「氣功對慢性疲勞綜合症及癌症的療效」。作為國際健康養生會主席、港大行為健康教研中心臨床顧問、註冊中醫師及中華傳統醫學研究所所長，袁教授在醫療界享有崇高的聲譽，曾榮獲聯合國特殊醫療貢獻獎和多項國際獎項。",
  "在行醫期間，袁教授觀察到都市人患慢性病多，特別是癌症，年輕化趨勢明顯。她指出，隨著香港社會壓力加劇，許多人身體健康受損。袁教授重點指出氣功可以改善新陳代謝，有助血液循環，提升氧氣供應，平衡五臟健康，並有效紓緩癌症化療的副作用。",
  ...
  "「五行平衡功」這套十式氣功療法，能提升身體對氧氣的吸收，促進五臟健康平衡，結合健康的生活習慣和飲食，對多種病症皆有療效，無論年齡與健康狀況均適合學習。一般而言，練習三周便可見效。",
];
